    ...
    <body>
        ...
        <div class="parameterDiv">
            <div class="leftDiv">
                <h2>Labor Library</h2>
                <p>
                    Use the search bar below to find specific topics or keywords within the library.
                </p>
                <input class="form-input" type="search" placeholder="🔍 Search " name="" id="">
                <p>
                    Explore a comprehensive collection of labor rights resources, 
                    including articles, guides, and legal information to empower 
